...
za $t\in [0, 2\pi]$ tj. preslikavi ki podvoji argument. V kompleksni notacijo bi jo zapisali z $e^{it} \mapsto e^{2it}$ ali $z \mapsto z^2$. Posledično je tudi $f$
kaotična.
\end{primer}
...
\begin{center}
    ...
    a_{n+1} = a_n + a_{n-1}.
    $$
    Podobno kot pri NDE, lahko rekurzivne enačbe prevedemo na sistem.
